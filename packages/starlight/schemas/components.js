	...
	return z
		.object({
			...
			*/
			 ...
			 */
			Head: z.string().default('@bablr/starlight/components/Head.astro'),
			 ...
			 */
			ThemeProvider: z.string().default('@bablr/starlight/components/ThemeProvider.astro'),
			...
			*/
			 ...
			 */
			SkipLink: z.string().default('@bablr/starlight/components/SkipLink.astro'),
			...
			*/
			 ...
			 */
			PageFrame: z.string().default('@bablr/starlight/components/PageFrame.astro'),
			/**
			 ...
			 */
			MobileMenuToggle: z.string().default('@bablr/starlight/components/MobileMenuToggle.astro'),
			 ...
			 */
			TwoColumnContent: z.string().default('@bablr/starlight/components/TwoColumnContent.astro'),
			...
			*/
			 ...
			 */
			Header: z.string().default('@bablr/starlight/components/Header.astro'),
			/**
			 ...
			 */
			SiteTitle: z.string().default('@bablr/starlight/components/SiteTitle.astro'),
			/**
			 ...
			 */
			Search: z.string().default('@bablr/starlight/components/Search.astro'),
			/**
			 ...
			 */
			SocialIcons: z.string().default('@bablr/starlight/components/SocialIcons.astro'),
			/**
			 ...
			 */
			ThemeSelect: z.string().default('@bablr/starlight/components/ThemeSelect.astro'),
			/**
			 ...
			 */
			LanguageSelect: z.string().default('@bablr/starlight/components/LanguageSelect.astro'),
			...
			*/
			 ...
			 */
			Sidebar: z.string().default('@bablr/starlight/components/Sidebar.astro'),
			/**
			 ...
			 */
			MobileMenuFooter: z.string().default('@bablr/starlight/components/MobileMenuFooter.astro'),
			...
			*/
			 ...
			 */
			PageSidebar: z.string().default('@bablr/starlight/components/PageSidebar.astro'),
			/**
			 ...
			 */
			TableOfContents: z.string().default('@bablr/starlight/components/TableOfContents.astro'),
			/**
			...
			MobileTableOfContents: z
				.string()
				.default('@bablr/starlight/components/MobileTableOfContents.astro'),
			...
			*/
			 ...
			 */
			Banner: z.string().default('@bablr/starlight/components/Banner.astro'),
			 ...
			 */
			ContentPanel: z.string().default('@bablr/starlight/components/ContentPanel.astro'),
			 ...
			 */
			PageTitle: z.string().default('@bablr/starlight/components/PageTitle.astro'),
			...
			FallbackContentNotice: z
				.string()
				.default('@bablr/starlight/components/FallbackContentNotice.astro'),
			...
			DraftContentNotice: z
				.string()
				.default('@bablr/starlight/components/DraftContentNotice.astro'),
			 ...
			 */
			Hero: z.string().default('@bablr/starlight/components/Hero.astro'),
			...
			*/
			 ...
			 */
			MarkdownContent: z.string().default('@bablr/starlight/components/MarkdownContent.astro'),
			...
			*/
			 ...
			 */
			Footer: z.string().default('@bablr/starlight/components/Footer.astro'),
			/**
			 ...
			 */
			LastUpdated: z.string().default('@bablr/starlight/components/LastUpdated.astro'),
			/**
			 ...
			 */
			Pagination: z.string().default('@bablr/starlight/components/Pagination.astro'),
			/**
			 ...
			 */
			EditLink: z.string().default('@bablr/starlight/components/EditLink.astro'),
		})
		.default({});
}
