...
export function ensureLeadingSlash(href) {
	if (href[0] !== '/') href = '/' + href;
	return href;
}

/** Ensure the passed path ends with a trailing slash. */
export function ensureTrailingSlash(href) {
	if (href[href.length - 1] !== '/') href += '/';
	return href;
}

/** Ensure the passed path starts and ends with slashes. */
export function ensureLeadingAndTrailingSlashes(href) {
...
export function stripLeadingAndTrailingSlashes(href) {
...
export function stripHtmlExtension(path) {
...
export function ensureHtmlExtension(path) {
