 ...
 */
export async function runPlugins(starlightUserConfig, pluginsUserConfig, context) {
...
export function injectPluginTranslationsTypes(translations) {
	...
	.function(
		z.tuple([
			z.object({
				 ...
				 * }
				 */
				updateConfig: z.function(z.tuple([z.record(z.any())]), z.void()),
				/**
